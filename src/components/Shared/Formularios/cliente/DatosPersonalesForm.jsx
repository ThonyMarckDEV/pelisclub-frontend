                ...
                <div className="flex gap-3">
                    <button
                        ...
                        className={`flex-1 flex items-center justify-center gap-2 py-3 rounded-xl border-2 font-black text-sm transition-all ${
                            !esEmpresa ? 'bg-secondary text-primary border-secondary' : 'bg-white text-slate-500 border-slate-200 hover:border-slate-300'
                        }`}
                    >
                    ...
                    <button
                        ...
                        onClick={() => onC('tipo', 2)}
                        className={`flex-1 flex items-center justify-center gap-2 py-3 rounded-xl border-2 font-black text-sm transition-all ${
                            esEmpresa ? 'bg-primary text-secondary border-primary' : 'bg-white text-slate-500 border-slate-200 hover:border-slate-300'
                        }`}
                    >
