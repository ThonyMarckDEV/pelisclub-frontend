...
const PeliculaDetalleModal = ({ slug, onClose }) => {
    ...
    return (
        <>
            ...
            {/* WRAPPER — el panel ahora ocupa todo el ancho, sin límite de w-[70%]/w-[60%] */}
            <div className="fixed inset-x-0 bottom-0 z-50 flex justify-center pointer-events-none">
                ...
                >
                    ...
                    {loading ? (
                        ...
                        <div className="h-56 flex flex-col items-center justify-center gap-3 text-white/30">
                            <Film size={32} />
                            <p className="text-sm font-semibold">No se pudo cargar la información.</p>
                        </div>
                    ) : (
                        <>
                            {/* BODY — scroll interno, contenido centrado con ancho máximo */}
                            ...
                            {/* FOOTER — fijo abajo, contenido centrado igual que el body */}
                            <div className="shrink-0 p-4 border-t border-white/10 bg-[#0D0C0E]">
                                <div className="max-w-2xl mx-auto">
                                    {tieneOpciones ? (
                                        <button
