...
const BASE_URL = `${API_BASE_URL}/api/video`;

export const indexPorPelicula = async (peliculaId) => {
    const response = await fetchWithAuth(`${BASE_URL}/pelicula/${peliculaId}`, { method: 'GET' });
