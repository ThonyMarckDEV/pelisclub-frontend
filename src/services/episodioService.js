...
const BASE_URL = `${API_BASE_URL}/api/episodio`;

export const indexPorTemporada = async (temporadaId) => {
    const response = await fetchWithAuth(`${BASE_URL}/temporada/${temporadaId}`, { method: 'GET' });
